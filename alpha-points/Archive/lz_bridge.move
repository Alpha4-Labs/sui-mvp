...
module alpha_points::lz_bridge {
    ...
    use alpha_points::ledger::{Self, Ledger, SupplyOracle};
    ...
    public fun send_bridge_packet(
        ...
        ledger::internal_spend(ledger, sender, amount, ctx, supply_oracle);
    ...
    public(package) fun receive_bridge_packet(
        ...
        ledger::internal_earn(ledger, dest_address, amount, ctx, supply_oracle);
