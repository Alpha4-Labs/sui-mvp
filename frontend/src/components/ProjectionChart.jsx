...
function ProjectionChart({
    projectionData = [],
    assetPriceData = [], // Array: [{ day: X, ALPHA: Y, ETH: Z }, ...]
    sources = [],        // Array: Full generation sources data
    sourceToggles = {},  // Object: { sourceId: boolean }
    assetToggles = {},   // Object: { ALPHA: boolean, ETH: boolean }
    onSourceToggle,      // Function: (sourceId) => void
    onAssetToggle        // Function: (assetSymbol) => void
}) {
