...
export function PartnerDashboard({ partnerCap: initialPartnerCap, onRefresh, currentTab = 'overview', onPartnerCreated }: PartnerDashboardProps) {
  console.log('[PartnerDashboard] Rendering with currentTab:', currentTab);
  ...
  // Track currentTab changes
  useEffect(() => {
    console.log('[PartnerDashboard] currentTab changed to:', currentTab);
  }, [currentTab]);
  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4 text-white">
        ...
        {/* Tab Content */}
        <div>
          {console.log('[PartnerDashboard] Rendering tab content for:', currentTab)}
          {currentTab === 'overview' && (console.log('[PartnerDashboard] Rendering overview tab'), renderOverviewTab())}
          {currentTab === 'perks' && (console.log('[PartnerDashboard] Rendering perks tab'), renderPerksTab())}
          {currentTab === 'analytics' && (console.log('[PartnerDashboard] Rendering analytics tab'), renderAnalyticsTab())}
          {currentTab === 'settings' && (console.log('[PartnerDashboard] Rendering settings tab'), renderSettingsTab())}
          {currentTab === 'generations' && (console.log('[PartnerDashboard] Rendering generations tab'), <GenerationsTab partnerCap={partnerCap} selectedPartnerCapId={selectedPartnerCapId} />)}
        </div>
      </div>
