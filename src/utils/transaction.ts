...
export const buildUnstakeTransaction = (
  ...
  // Updated for Sui Move 1.0 - Use V2 function with correct Alpha Points calculation
  tx.moveCall({
    target: `${PACKAGE_ID}::integration::request_unstake_native_sui_v2`,
    arguments: [
 ...
 * Uses V2 function with correct Alpha Points calculation (not 223x inflated)
 * 
...
export const buildEarlyUnstakeTransaction = (
  ...
  tx.moveCall({
    ...
    arguments: [
      ...
      tx.object(SUI_SYSTEM_STATE_ID)           // SuiSystemState (use constant instead of hardcoded)
    ]
  });
