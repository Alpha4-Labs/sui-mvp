...
__export(wallet_exports, {
  ...
  defaultWindowFeatures: () => defaultWindowFeatures,
  ...
  constructor({
    ...
    __privateAdd(this, _signAndExecuteTransaction, async ({
      ...
      return {
        ...
        signature,
        bytes,
        effects: (0, import_utils.toBase64)(Uint8Array.from(rawEffects))
      };
    });
  ...
  if (state.address && state.publicKey) {
    __privateSet(this, _accounts, [
      new import_wallet_standard.ReadonlyWalletAccount({
        ...
        publicKey: (0, import_utils.fromBase64)(state.publicKey)
      })
    ]);
  } else {
    __privateSet(this, _accounts, []);
...
function registerEnokiWallets({
  ...
  const flow = new import_state.INTERNAL_ONLY_EnokiFlow({ ...config, network });
